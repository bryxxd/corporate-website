    ...
    <section class="p-service">
        <figure class="c-figure">
            <img class="c-figure__img"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/views/service/pc/img-intro.jpg"
                alt="Service Figure">
        </figure>
            ...
            <div class="p-service__inner">
                ...
                <div class="p-service__inner__details">
                    <div class="p-service__inner__details__item">
                        <img class="p-service__inner__photos__figure__img u-display-below-pc-only"
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/views/service/pc/img-service-figure1.jpg"
                            alt="About Figure">
